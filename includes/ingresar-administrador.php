...
?>
<h1 class="h3 mb-0 text-gray-800" >Ingresar administrador</h1>

	<div class="row" id="formulario">		
			<form class="row g-3" method="POST"  action="./bdatos/padministracion/ingresador-pa.php"  >
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<label for="entrada" class="form-label">Dirección</label>
