...
?>
<h1 class="h3 mb-0 text-gray-800" >Ingresar bodega</h1>

	<div class="row" id="formulario">		
			<form class="row g-3" method="POST"  action="./bdatos/bodega/ingresador-b.php"  >
			<div class="col-md-6">
				<label for="name" class="form-label">Número de bodega</label>
