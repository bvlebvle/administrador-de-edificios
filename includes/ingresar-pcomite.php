...
?>
<h1 class="h3 mb-0 text-gray-800" >Ingresar miembro de comité</h1>

	<div class="row" id="formulario">		
			<form class="row g-3" method="POST"  action="./bdatos/pcomite/ingresador-pc.php"  >
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="nombre"placeholder="Valentina Almendra Díaz Gonzalez">
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<label for="entrada" class="form-label">Rol</label>
				<input type="text" class="form-control" name="rol" placeholder="">
			</div>
			<div class="col-md-6">
